...
public class Position {
	...
	private static final double length1 = 0.0003*Math.sin(Math.toRadians(67.5));//r*sin67.5 length
	private static final double length2 = 0.0003*Math.sin(Math.toRadians(45)); //r*sin45 length
	private static final double length3 = 0.0003*Math.sin(Math.toRadians(22.5)); //r*sin22.5 length
